...
const framework::ObservableListProperty<mpw::LogEntry>& GameLog::logEntriesProperty() noexcept {
	return this->logEntries;
}

framework::ObjectListView<LogEntry>& GameLog::getLogEntries() noexcept {
	return this->logEntries;
}
