...
public:
	...
	virtual const framework::ObservablePrimitiveProperty<std::string>& imageNameProperty() noexcept;

	virtual const framework::ObservablePrimitiveProperty<int>& rotationProperty() noexcept;

	virtual const framework::ObservablePrimitiveProperty<bool>& visibleProperty() noexcept;

	virtual std::string getImageName() noexcept;
