...
public:
	...
	virtual const framework::ObservableListProperty<commands::Command>& executedCommandsProperty() noexcept;

	virtual const framework::ObservableListProperty<commands::Command>& undoneCommandsProperty() noexcept;

	virtual framework::ObjectListView<Command>& getExecutedCommands() noexcept;

	virtual framework::ObjectListView<Command>& getUndoneCommands() noexcept;
