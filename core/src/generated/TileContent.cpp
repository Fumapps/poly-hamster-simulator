...
const framework::ObservableObjectProperty<mpw::Tile>& TileContent::currentTileProperty() noexcept {
	return this->currentTile;
}

const framework::ObservableObjectProperty<mpw::Stage>& TileContent::stageProperty() noexcept {
	return this->stage;
}
