...
public:
	...
	virtual const framework::ObservableObjectProperty<mpw::Tile>& currentTileProperty() noexcept;

	virtual const framework::ObservableObjectProperty<mpw::Stage>& stageProperty() noexcept;
