...
public:
	...
	virtual const framework::ObservablePrimitiveProperty<mpw::Mode>& modeProperty() noexcept;

	virtual const framework::ObservablePrimitiveProperty<double>& speedProperty() noexcept;

	virtual const framework::ObservablePrimitiveProperty<bool>& delayEnabledProperty() noexcept;
