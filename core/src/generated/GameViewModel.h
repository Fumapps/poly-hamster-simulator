...
public:
	...
	virtual const framework::ObservableListProperty<viewmodel::ViewModelRow>& rowsProperty() noexcept;

	virtual const framework::ObservableListProperty<viewmodel::ViewModelLogEntry>& logEntriesProperty() noexcept;

	virtual const framework::ObservablePrimitiveProperty<mpw::Size>& sizeProperty() noexcept;

	virtual const framework::ObservablePrimitiveProperty<bool>& playButtonEnabledProperty() noexcept;

	virtual const framework::ObservablePrimitiveProperty<bool>& pauseButtonEnabledProperty() noexcept;

	virtual const framework::ObservablePrimitiveProperty<bool>& undoButtonEnabledProperty() noexcept;

	virtual const framework::ObservablePrimitiveProperty<bool>& redoButtonEnabledProperty() noexcept;

	virtual const framework::ObservablePrimitiveProperty<double>& speedProperty() noexcept;

	virtual framework::ObjectListView<ViewModelRow>& getRows() noexcept;

	virtual framework::ObjectListView<ViewModelLogEntry>& getLogEntries() noexcept;
