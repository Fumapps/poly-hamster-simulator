...
public:
	...
	virtual const framework::ObservableListProperty<mpw::LogEntry>& logEntriesProperty() noexcept;

	virtual framework::ObjectListView<LogEntry>& getLogEntries() noexcept;
