...
const framework::ObservableListProperty<mpw::Tile>& Stage::tilesProperty() noexcept {
	return this->tiles;
}

const framework::ObservableListProperty<mpw::TileContent>& Stage::tileContentsProperty() noexcept {
	return this->tileContents;
}

const framework::ObservablePrimitiveProperty<mpw::Size>& Stage::stageSizeProperty() noexcept {
	return this->stageSize;
}

framework::ObjectListView<Tile>& Stage::getTiles() noexcept {
	return this->tiles;
}

framework::ObjectListView<TileContent>& Stage::getTileContents() noexcept {
	return this->tileContents;
}
