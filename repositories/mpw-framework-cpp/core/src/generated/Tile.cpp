...
const framework::ObservableListProperty<mpw::TileContent>& Tile::contentsProperty() noexcept {
	return this->contents;
}

const framework::ObservablePrimitiveProperty<mpw::Location>& Tile::locationProperty() noexcept {
	return this->location;
}

const framework::ObservableObjectProperty<mpw::Tile>& Tile::southProperty() noexcept {
	return this->south;
}

const framework::ObservableObjectProperty<mpw::Tile>& Tile::northProperty() noexcept {
	return this->north;
}

const framework::ObservableObjectProperty<mpw::Tile>& Tile::eastProperty() noexcept {
	return this->east;
}

const framework::ObservableObjectProperty<mpw::Tile>& Tile::westProperty() noexcept {
	return this->west;
}

framework::ObjectListView<TileContent>& Tile::getContents() noexcept {
	return this->contents;
}
