...
const framework::ObservablePrimitiveProperty<std::string>& LogEntry::messageProperty() noexcept {
	return this->message;
}

const framework::ObservableObjectProperty<mpw::Actor>& LogEntry::actorProperty() noexcept {
	return this->actor;
}

std::string LogEntry::getMessage() noexcept {
