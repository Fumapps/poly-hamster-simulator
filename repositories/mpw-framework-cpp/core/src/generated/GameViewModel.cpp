...
const framework::ObservableListProperty<viewmodel::ViewModelRow>& GameViewModel::rowsProperty() noexcept {
	return this->rows;
}

const framework::ObservableListProperty<viewmodel::ViewModelLogEntry>& GameViewModel::logEntriesProperty() noexcept {
	return this->logEntries;
}

const framework::ObservablePrimitiveProperty<mpw::Size>& GameViewModel::sizeProperty() noexcept {
	return this->size;
}

const framework::ObservablePrimitiveProperty<bool>& GameViewModel::playButtonEnabledProperty() noexcept {
	return this->playButtonEnabled;
}

const framework::ObservablePrimitiveProperty<bool>& GameViewModel::pauseButtonEnabledProperty() noexcept {
	return this->pauseButtonEnabled;
}

const framework::ObservablePrimitiveProperty<bool>& GameViewModel::undoButtonEnabledProperty() noexcept {
	return this->undoButtonEnabled;
}

const framework::ObservablePrimitiveProperty<bool>& GameViewModel::redoButtonEnabledProperty() noexcept {
	return this->redoButtonEnabled;
}

const framework::ObservablePrimitiveProperty<double>& GameViewModel::speedProperty() noexcept {
	return this->speed;
}

framework::ObjectListView<ViewModelRow>& GameViewModel::getRows() noexcept {
	return this->rows;
}

framework::ObjectListView<ViewModelLogEntry>& GameViewModel::getLogEntries() noexcept {
	return this->logEntries;
}
